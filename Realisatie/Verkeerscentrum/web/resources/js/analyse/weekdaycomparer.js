...
function viewAnalyseData(data){
    ...
    //
    var y2 = [];
    y2 = parseDayData("Maandag",route.data.duration.data.MONDAY);
    y.push(y2);
    y2 = parseDayData("Dinsdag",route.data.duration.data.TUESDAY);
    y.push(y2);
    y2 = parseDayData("Woensdag",route.data.duration.data.WEDNESDAY);
    y.push(y2);
    y2 = parseDayData("Donderdag",route.data.duration.data.THURSDAY);
    y.push(y2);
    y2 = parseDayData("Vrijdag",route.data.duration.data.FRIDAY);
    y.push(y2);
    y2 = parseDayData("Zaterdag",route.data.duration.data.SATERDAY);
    y.push(y2);
    y2 = parseDayData("Zondag",route.data.duration.data.SUNDAY);
    y.push(y2);
