 ...
 * @author Mike
 */
@ManagedBean(name = "Rushhour", eager = true)
@RequestScoped
public class Rushhours extends AnalysePage implements ITableView, IGraphView {
    ...
    public String getDataURL() {
        ...
        url.append(super.prop.getProperty("urlRushhour"));
